...
This a fork of the solder reflow plate project by AfterEarth Ltd, I have separated the project into 2 different repositories for the firmware and the hardware. I also have shifted the project from arduino ide to PlatformIO. As soon as the testing of the project ends, I look forward to merge this into the original Repository.
**Happy Hacking!!!**
